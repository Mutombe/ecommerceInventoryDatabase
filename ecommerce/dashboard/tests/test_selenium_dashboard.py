...
def test_dashboard__admin_login(live_server, db_fixture_setup,chrome_browser_instance):
    ...
    user_name.send_keys("Simbarashe")
    user_password.send_keys("Simbarashe2001")
